...
-- CreateIndex
CREATE UNIQUE INDEX "Admin_student_key" ON "Admin"("student");
...
-- AddForeignKey
ALTER TABLE "Class" ADD CONSTRAINT "Class_supervisonId_fkey" FOREIGN KEY ("supervisonId") REFERENCES "Teacher"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
